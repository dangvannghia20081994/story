@if (! ($crawlerTokenConfigured ?? true))
    <div class="card" style="border-color: #f59e0b; background: #fffbeb; margin-bottom: 1rem;">
        <strong>Chưa cấu hình <code>CRAWLER_INTERNAL_TOKEN</code> trên backend</strong>
        <p class="muted" style="margin: 0.45rem 0 0.65rem;">Worker Python gọi <code>/api/internal/crawler/*</code> sẽ bị 503 cho đến khi token được đặt trong <code>backend/.env</code> và cùng giá trị trong <code>crawler/.env</code>.</p>
