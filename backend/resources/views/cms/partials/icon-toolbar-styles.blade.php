...
<style>
    ...
    @media (prefers-color-scheme: dark) {
        .icon-btn:hover:not(:disabled) { background: #1e293b; color: #a5b4fc; border-color: #475569; }
    }
    ...
    @media (prefers-color-scheme: dark) {
        .icon-btn--danger { border-color: #7f1d1d; color: #fca5a5; background: rgba(63, 15, 15, 0.35); }
    }
    .icon-btn--danger:hover:not(:disabled) { background: #fee2e2; color: #b91c1c; border-color: #f87171; }
    @media (prefers-color-scheme: dark) {
        .icon-btn--danger:hover:not(:disabled) { background: #450a0a; }
    }
    .th-actions {
        width: 1%;
        white-space: nowrap;
